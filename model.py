...
class VisionTransformer(nn.Module):
    ...
    def forward(self, x: torch.Tensor):
        ...
        x = torch.reshape(x.permute(0, 2, 1), (x.shape[0], -1, self.image_size // self.patch_size, self.image_size // self.patch_size))
...
class SETR(nn.Module):
    def __init__(self, 
        ...
        self.decoder = Decoder2D(1000, output_dim, features=[512, 256, 256, out_channels])
